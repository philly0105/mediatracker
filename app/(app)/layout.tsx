...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    // MotionProvider wraps only the authenticated subtree so Framer Motion consumers
    // respect reducedMotion="user" without placing Framer Motion into the root layout.
    <MotionProvider>
