          ...
          <AnimatePresence>
            {toasts.map((t) => (
              <motion.div
                ...
                className={`pointer-events-auto flex items-center gap-3 w-full md:w-auto md:max-w-sm px-4 py-3 rounded-[var(--radius-md)] backdrop-blur-xl border shadow-2xl shadow-black/50 bg-[var(--bg-void)]/95 ${TONE_STYLES[t.tone].card}`}
              >
